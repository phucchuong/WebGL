...
//
Matrix & Matrix::SetRotaionZXY(GLfloat angleX, GLfloat angleY, GLfloat angleZ )
{
...
Matrix & Matrix::SetRotaionZXY(const Vector3 & rotation)
{
	Matrix rotX, rotY, rotZ;
...
Matrix & Matrix::SetRotaionZXY( GLfloat * pRotation)
{
	Matrix rotX, rotY, rotZ;
	rotX.SetRotationX ( pRotation[0] );
	rotY.SetRotationY ( pRotation[1] );
	rotZ.SetRotationZ ( pRotation[2] );
	*this = rotZ * rotX * rotY;
	return *this;
}

Matrix & Matrix::SetRotaionYXZ(GLfloat angleX, GLfloat angleY, GLfloat angleZ )
{
	Matrix rotX, rotY, rotZ;
	rotX.SetRotationX ( angleX );
	rotY.SetRotationY ( angleY );
...
Matrix & Matrix::SetRotaionYXZ(const Vector3 & rotation)
{
	Matrix rotX, rotY, rotZ;
	rotX.SetRotationX ( rotation.x );
	rotY.SetRotationY ( rotation.y );
...
Matrix & Matrix::SetRotaionYXZ( GLfloat * pRotation)
{
	Matrix rotX, rotY, rotZ;
	rotX.SetRotationX ( pRotation[0] );
	rotY.SetRotationY ( pRotation[1] );
